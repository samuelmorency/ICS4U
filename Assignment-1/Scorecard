...
public class ScoreCard {
	...
	public int calculateTotal()
	{
		...
		if (_scores[0][0] + _scores[0][1] + _scores[0][2] + _scores[0][3] + _scores[0][4] + _scores[0][5] >= 63)
		{
			total = total + 35;
		}
	...
	public void scoreSmStraight(int dice1, int dice2, int dice3, int dice4, int dice5)
	{
		...
		try{
			if (((sortedList.get(0) == sortedList.get(1) - 1) || (sortedList.get(4) == sortedList.get(3) + 1)) &&
